...
<html lang="en">
    ...
    <body id="page-top">
       ...
       <div class="logo">
        <img  src="assets/img/logo1.png" width="30%" height="30%" style="margin-bottom: -5%; margin-top: -2%;" alt="..." />
        </div>
        <nav class="navbar navbar-expand-lg navbar-dark navbar-shrink" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="#page-top">Data Concept Informatic</a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                        <li class="nav-item"><a class="nav-link" href="#portfolio">Réseaux et Télécom</a></li>
                        <li class="nav-item"><a class="nav-link" href="#borne">Bornes électriques</a></li>
        ...
        <header class="masthead">
                ...
                <div class="container">
                    <div class="masthead-heading text-uppercase">maintenance réseaux télécom</div>
                </div>
       ...
       <section class="page-section bg-light" id="portfolio">
        <div class="container">
            <div class="text-center">
                <h2 class="section-heading text-uppercase">RÉSEAUX ET TÉLÉCOM</h2>
                <h3 class="section-subheading text-muted">
                    Nous avons mis en place une organisation miroir afin de répondre de manière efficace et proactive aux besoins de nos clients. Cette structure nous permet de garantir une réponse rapide et adaptée à chaque demande, tout en assurant la satisfaction client. En alignant notre organisation sur celle de nos clients, nous sommes en mesure de comprendre et d'anticiper leurs attentes, ce qui nous permet d'établir des relations solides et durables basées sur la confiance et la collaboration.</h3>
            </div>
            <div class="row">
            ...
            <div style="width:100%; height:100%;">
                            <img class="img-fluid  mx-auto" src="assets/img/portfolio/1.jpg" alt="..." /></div>                        </a>
                        <div class="portfolio-caption">
                            <div class="portfolio-caption-heading">FTTH</div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 mb-4">
                    ...
                    <div class="portfolio-item">
                        ...
                        <div class="portfolio-caption">
                            <div class="portfolio-caption-heading">Ligne terminale</div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 mb-4">
                    ...
                    <div class="portfolio-item">
                        ...
                        <div class="portfolio-caption">
                            <div class="portfolio-caption-heading">Installation de bornes wifi</div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 mb-4">
                    ...
                    <div class="portfolio-item">
                        ...
                        <div class="portfolio-caption">
                            <div class="portfolio-caption-heading">la conduite d'activité</div>
                        </div>
                    </div>
                </div>
        ...
        <!-- bornes electrique-->
        <section class="page-section" id="borne">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase">BORNES ÉLECTRIQUES</h2>
                    <h3 class="section-subheading text-muted">Pour chacune de nos solutions, nous proposons un service clé en main adapté à vos besoins:</h3>
                </div>
                <div class="row text-center">
                    <div class="col-md-3">
                        <span class="fa-stack fa-4x">
                            <img class="rounded-circle img-fluid" src="assets/img/borne/1.jpg" alt="..." />
                        </span>
                        <h4 class="my-3">Pour les collectivités - domaine public</h4>
                        <p class="text-muted">• Bornes ouvertes au public <br> • Bornes privées</p>
                    </div>
                    <div class="col-md-3">
                        <span class="fa-stack fa-4x">
                            <img class="rounded-circle img-fluid" src="assets/img/borne/2.jpg" alt="..." />

                        </span>
                        <h4 class="my-3">Pour les particuliers</h4>
                        <p class="text-muted">• Nous assurons une solution tout en un, pour le raccordement du compteur jusqu’à la borne.</p>
                    </div>
                    <div class="col-md-3">
                        <span class="fa-stack fa-4x">
                            <img class="rounded-circle img-fluid" src="assets/img/borne/3.jpg" alt="..." />

                        </span>
                        <h4 class="my-3">Pour les copropriétés</h4>
                        <p class="text-muted">• Nous réalisons du précâblage pour immeubles en collectif, le pré-équipement des bâtiments en infrastructure de recharge pour véhicules électriques.
                    </div>
                    <div class="col-md-3">
                        <span class="fa-stack fa-4x">
                            <img class="rounded-circle img-fluid" src="assets/img/borne/4.jpg" alt="..." />

                        </span>
                        <h4 class="my-3">Les panneaux photovoltaïques</h4>
                        <p class="text-muted">• Vous pouvez réduire votre empreinte carbone en utilisant une source d'énergie propre et renouvelable.
                    </div>
                </div>
            </div>
        </section>
         ...
         <section class="page-section" id="about">
            <div class="container">
                ...
                <li>
                        ...
                        <div class="timeline-panel" style="text-align: left; text-justify: initial;">
                            <div class="timeline-heading" >
                                <h4 class="subheading">
                                    Qui sommes nous?</h4>
                            </div>
                            <div class="timeline-body"><p class="text-muted">Fort de notre expérience de 10 ans dans le monde des télécoms nous offrons une expertise partagée dans les opérations en direct ou via des mandataires tels que SPIE City & Network, Ensio, Sogetrel, Axians, Scopelec, Circet, Solutions 30, Axione, et Altitude. Nous offrons une expertise partagée dans les opérations pour divers opérateurs tels qu'Orange, BYTEL , Free et Altitude. Notre organisation possède une expérience approfondie avec différents opérateurs dans des zones variées telles que AMII/RIP/AMEL pour le FETA, ainsi que pour Orange dans le déploiement du réseau cuivre.</p></div>
                            <div class="timeline-heading">
                                <h4 class="subheading">
                                    <br>Nos agences<br></h4>
                            </div>
                            <div class="timeline-body"><div class="carte">
			...
			<g class="region region-11" data-nom="Île-de-France" data-code_insee="11">
				...
				<path data-nom="Val-d’Oise" data-numerodepartement="95" class="region-11 agence departement departement-95 departement-val-doise" d="m374.3,144l-9.5-0.8l4-9.5l1.6,3.2l5.6,1.1 l6.3-1.8l9.2,2.2l2.2-1.6l10.9,6.4l0.2,2l-1.7,2.3l-0.1,0.1c-1.5,1.1-3.1,2.2-4.7,3.3l-2.6-1.1l-3.3,1.3l-3.6,2.6l-5.5-6.1 L374.3,144z"><title>Bureau dans le Val D’Oise</title></path>
			</g>
			<g class="region region-24" data-nom="Centre-Val de Loire" data-code_insee="24">
				...
				<path data-nom="Indre-et-Loire" data-numerodepartement="37" class="region-24 agence departement departement-37 departement-indre-et-loire" d="m303.9,263l-5.5-3.2v-0.1l5.8-15.3l1.7-9.3 l0.7-2.4l6.1,2.6l-0.5-3.3l2.8,0.3l7.7-4.5l10.5,0.5l-0.2,5.5l2.2-1.8l6,3.4l-0.7,2.7l3.4,5.1l-1.2,9.1l2.4,1.9l2.6-1.3l4.2,6.7 l1,4.9l-2.5,2.1l-2.6,3.5l-2.3-1.7l-5.1,2.7l-3.3,11.9l1,2.7l-5.6,0.5l-7.1-10l-0.3-3.1l-5.3-3l1.4,2.9l-10,0.4l-2.8-1.4l-1.3-6.1 l-2.9,0.3L303.9,263z"><title>Bureau dans Indre-et-Loire</title></path>
			...
			<g class="region region-93" data-nom="Provence-Alpes-Côte d&#39;Azur" data-code_insee="93">
				...
				<path data-nom="Bouches-du-Rhône" data-numerodepartement="13" class="region-93 agence departement departement-13 departement-bouches-du-rhone" d="m545,500.2l2.5-2l-2.2-6.3l1.1-2.6l2.7-0.5 l-5.5-9.1l2-5.3l3.3-0.8l-1.9-3.8l-0.1-0.1l-6.6,4.3l-3.2,0.2l-12-4.8l-3.5,0.7l-4.5-2.3l-5.5-5.7l-10.4-2.9l-3.9,4.1l-1.9,10.6 l-3.3-0.9l-4.2,4.8l1,2.7l-5.8,1.8l-3.1,4.9l0.2,0.1h13.2l2.2,0.9l1,2.2l-1.6,1.5l2.2,1.4l7.4,0.1l3.2,1.3l1.8-1.7l-1.5-2.8l0.4-2.4 l4.9,1l3,5.3l10-0.8l2.6-1.1l1.8,2l-0.2,2.5l1,2l-1.2,2.2h9.2l1.3,2l2.2-0.8l1.7,0.2L545,500.2z"><title>Bureau dans Bouches-du-Rhône</title></path>
    ...
    <div class="timeline-body"><p class="text-muted"><br>  • Bureau dans le Val D’Oise ( 95 ) <br>
                                                        • Bureau dans  la marne ( 51 )<br>
                                                        • Bureau dans Indre-et-Loire ( 37 )<br> 
                                                        • Bureau dans Bouches-du-Rhône ( 13)</p></div>
                    ...
                    <li class="timeline-inverted">
                        ...
                        <div class="timeline-panel" style="text-align: left; text-justify: initial;">
                            ...
                            <div class="timeline-body"><p class="text-muted">Pour répondre efficacement aux exigences des opérateurs sur le terrain, nous disposons de moyens matériels et humains complets. Tous nos techniciens sont équipés de téléphones portables, de tablettes ou de smartphones, leur permettant ainsi de travailler en toute mobilité. Ils sont capables de réaliser des essais, de remonter les informations en temps réel, de communiquer avec les clients finaux, de renseigner les dossiers techniques, de prendre des photos et de compléter les comptes rendus d'intervention. De plus, nous mettons à disposition un parc de nacelles et des véhicules utilitaires pour chaque équipe. Nos équipes sont constituées de binômes et sont équipées des équipements de protection individuelle nécessaires.</p></div>
                        </div>
                    </li>
                    
                        <li>
                            <div class="timeline-image">
                                <i class="fa fa-location rounded-circle img-fluid" ></i>
                            </div>
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                                    <h4>4 BD DE CHINON 37510 <br>BALLAN-MIRE <br></h4><h5>Téléphone : 0664040018</h5><h5>Mail : contact@data-concept.fr</h5>
        ...
        <section class="page-section" id="borne">
            <div class="container">
                ...
                <div class="row text-center">
                    <div class="col-md-2">
                        <span class="fa-stack fa-4x">
                            <img class="rounded-circle img-fluid" src="assets/img/about/partenaire/1.jpg" alt="..." />
                        </span>
                    </div>
                    <div class="col-md-2">
                        <span class="fa-stack fa-4x">
                            <img class="rounded-circle img-fluid" src="assets/img/about/partenaire/2.jpg" alt="..." />
                    ...
                    <div class="col-md-2">
                        <span class="fa-stack fa-4x">
                        <img class="rounded-circle img-fluid" src="assets/img/about/partenaire/3.jpg" alt="..." />
                    ...
                    <div class="col-md-2">
                        <span class="fa-stack fa-4x">
                        <img class="rounded-circle img-fluid" src="assets/img/about/partenaire/4.jpg" alt="..." />
                    ...
                    <div class="col-md-2">
                        <span class="fa-stack fa-4x">
                        <img class="rounded-circle img-fluid" src="assets/img/about/partenaire/5.png" alt="..." />
                ...
                <form id="contactForm" method="post"  action="mail.php">
                    <div class="row align-items-stretch mb-5">
                        <div class="col-md-6">
                            <div class="form-group">
                                <!-- Name input-->
                                <input class="form-control" id="name" name="nom" type="text" placeholder="votre nom et prenom *" data-sb-validations="required" />
                            ...
                            <div class="form-group mb-md-0">
                                <!-- Phone number input-->
                                <input class="form-control" id="phone" name="numtel" type="tel" placeholder="numero de telephone *" data-sb-validations="required" />
                                <div class="invalid-feedback" data-sb-feedback="phone:required">numero de telephone obligatoire.</div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group form-group-textarea mb-md-0">
                                <!-- Message input-->
                                <textarea class="form-control" name="message" id="message" placeholder="votre question *" data-sb-validations="required"></textarea>
                                <div class="invalid-feedback" data-sb-feedback="message:required">ce champ obligatoire.</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="d-none" id="submitSuccessMessage">
                        <div class="text-center text-white mb-3">
                            <div class="fw-bolder">Nous avons reçu votre message !</div>
                    ...
                    <!-- Submit Button-->
                    <div class="text-center"><button class="btn btn-primary btn-xl text-uppercase" id="submitButton" name="send" type="submit">envoyer</button></div>
                </form>
            </div>
        </section>
        <!-- Footer-->
        <footer class="footer py-4">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-4 text-lg-start">Copyright &copy; DCI 2024</div>
                ...
                <div class="modal-content">
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            ...
                            <img class="img-fluid  mx-auto" src="assets/img/portfolio/1.jpg" alt="..." /></div>
                            <div class="col-lg-12">
                                <div class="modal-body">
                                    <!-- Project details-->
                                    <h3 class="text-uppercase">FTTH : Déploiement et maintenance T + D1, D2 (horizontal et vertical (pré-fibrage immeubles)</h2>
                                    
                                    <p style="text-align: left;">• Cuivre : maintenance sur la distribution, création artères de distribution (SR vers PC), réparation de paires en distribution<br>
                                        • Génie Civil : remplacement de trappes, fouilles, câble enterré, tranchées fonçage<br>
                                        • Poteaux : Pose/dépose, remplacement, renforcement d’appuis (bois, métal, composite)<br>
                                        • Création / remplacement et maintenance d’armoires/serrures (FTTH)</p>
                                        <p>Pour tous les travaux, nous avons le savoir faire pour le traitement administratif et réglementaire : DT/DICT, autorisation de voierie, DOE
                                        </p>
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            ...
                            <div class="col-lg-12">
                                <div class="modal-body">
                                    <!-- Project details-->
                                    <h3 class="text-uppercase">Ligne terminale : marché Résidentiels, Professionnels et Entreprise</h2>
                                     <img class="img-fluid  mx-auto" src="assets/img/portfolio/3.jpg" alt="..." />
                                    <p  style="text-align: left;">raccordement et maintenance sur le réseau cuivre et fibre optique,<br>
                                        • FTTH : du PB jusque chez le client PTO/DTIO = câblage desserte interne et desserte câblée des parties commune d’immeuble)<br>
                                        • Cuivre : du PC jusque chez le client (DTI/PDF = câblage desserte interne et desserte câblée des parties commune d’immeuble)<br>
                                        multiservice tous supports (cuivre et FTTH) :  installation de box, optimisation wifi ,  décodeurs TV
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                             <div style="width:40%; height:40%;">
                            <img class="img-fluid  mx-auto" src="assets/img/portfolio/4.jpg" alt="..." /></div>
                            <div class="col-lg-12">
                                <div class="modal-body">
                                    <!-- Project details-->
                                    <h3 class="text-uppercase">Installation de bornes wifi Grand Comptes sur le territoire national</h3>
                                    <p>• Visites techniques<br>
                                       • Pose et configuration des bornes et serveurs<br>
                                       • Brassage des baies (RJ45)<br>
                                       • Mises en service, mesures<br>
                                       • Recettes</p>
                ...
                <div class="modal-content">
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            ...
                            <img class="img-fluid  mx-auto" src="assets/img/portfolio/5.jpg" alt="..." /></div>
                            <div class="col-lg-12">
                                <div class="modal-body">
                                    <!-- Project details-->
                                    <h3 class="text-uppercase">la conduite d'activité</h3>
                                    <p style="text-align: left;">
                                    Nous avons mis en place une structure organisationnelle axée sur la satisfaction de nos clients, grâce à une approche en miroir qui nous permet de répondre efficacement à leurs besoins. Cette organisation se déploie à travers plusieurs rôles clés :<br>
                                       • Une équipe dédiée à la gestion opérationnelle, chargée de coordonner les appels préalables, le suivi des interventions, les clôtures et le traitement des GeM en respectant scrupuleusement nos processus opérationnels.<br>
                                       • Des managers et conducteurs de travaux qui assurent un suivi technique étroit des équipes sur le terrain, garantissant ainsi la qualité et la sécurité des travaux réalisés conformément aux normes établies par nos partenaires opérateurs.<br>
                                       •Des responsables de projets qui veillent au suivi contractuel, en se concentrant sur les indicateurs de performance clés, le respect des termes du contrat et la gestion des prix.<br>
                                       <br>Cette approche holistique garantit que nous sommes parfaitement alignés sur les attentes de nos clients, tout en maintenant des normes élevées de qualité, de sécurité et d'efficacité opérationnelle.</p>
